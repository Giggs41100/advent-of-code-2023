...
public class Day2Exercises {
    ...
    private static final String EXERCISE1_NAME = "Advent of Code 2023 - Day 2 - Exercise 1";
    private static final String EXERCISE2_NAME = "Advent of Code 2023 - Day 2 - Exercise 2";
    private static final String EXERCISE_INPUT_PATH = "src/main/resources/";
    private static final String EXERCISE_INPUT_FILE = "2023-Day2.txt";
    //private static final String EXERCISE_INPUT_FILE = "2023-Day2-test.txt";
    ...
    public static void launchExercise1()  {
        ...
        try {
            Path path = Paths.get(Day2Exercises.class.getClassLoader()
                    .getResource(EXERCISE_INPUT_FILE).toURI());

            Stream<String> lines = Files.lines(path);
            var total = lines.filter(AdventStringUtils::isNotAValidGame).mapToInt(AdventStringUtils::getGameId).sum();
            lines.close();
